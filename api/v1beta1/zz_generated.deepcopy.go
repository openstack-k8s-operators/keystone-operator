...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalKeystoneAPI) DeepCopyInto(out *ExternalKeystoneAPI) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalKeystoneAPI.
func (in *ExternalKeystoneAPI) DeepCopy() *ExternalKeystoneAPI {
	if in == nil {
		return nil
	}
	out := new(ExternalKeystoneAPI)
	in.DeepCopyInto(out)
	return out
}
