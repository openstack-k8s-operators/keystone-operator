...
require (
	...
	k8s.io/apiextensions-apiserver v0.29.0 // indirect; indirect // indirect
	k8s.io/component-base v0.29.0 // indirect; indirect // indirect
	k8s.io/klog/v2 v2.110.1 // indirect
	k8s.io/kube-openapi v0.0.0-20231214164306-ab13479f8bf8 // indirect; indirect // indirect
