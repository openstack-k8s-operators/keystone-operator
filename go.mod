...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common v0.3.1-0.20231113161013-c2905b3dfe21
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.1.1-0.20231001084618-12369665b166
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20230922161820-e6fe1f3e921b
...
// WIP
replace github.com/openstack-k8s-operators/mariadb-operator/api => github.com/dciabrin/mariadb-operator/api v0.0.0-20231109132245-e4f24a0c5588

replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/dciabrin/lib-common/modules/common v0.0.0-20231006083235-f21280cd22c6
